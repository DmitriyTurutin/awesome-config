...
if awesome.startup_errors then
	naughty.notify({
		...
		title = "There is something wrong in your code, Dima",
...
awful.util.tagnames = { "</> ", "web ", "I ", " II ", " III " }
...
globalkeys = mytable.join(
	...
	-- locker
	awful.key({ modkey, "l" }, "c", function()
		awful.util.spawn("slock")
	end, { descrition = "locker", group = "awesome" }),
	...
	end, { description = "run Android Studio", group = "development" }),
	-- Brave
	awful.key({ modkey }, "b", function()
		awful.util.spawn("brave")
	end, { descrition = "run browser", group = "hotkeys" }),

	-- Obsidian
	awful.key({ modkey }, "o", function()
		awful.util.spawn("obsidian")
	end, { descrition = "run Obsidian", group = "applications" }),

	-- Passmenu
	awful.key({ modkey }, "p", function()
		awful.util.spawn("passmenu")
	end, { descrition = "passwords", group = "applications" }),
	-- WebStorm
	awful.key({ modkey }, "w", function()
		awful.util.spawn("webstorm")
	end, { descrition = "run webstorm", group = "development" }),

	-- Change language to english
	awful.key({ "Control" }, "space", function()
		awful.util.spawn("setxkbmap -layout us")
	end, { description = "English layout", group = "Controls" }),
	awful.key({ modkey, "Control" }, "space", function()
		awful.util.spawn("setxkbmap -layout ru")
	end),
	...
	--    local us = "us"
	--        function()
	--          os.execute(string.format("setxbmap -layout %s"), ru or us)
	--        end
	--    ),
	-- Screenshot
	awful.key({}, "Print", function()
		awful.util.spawn("flameshot gui")
	end, { description = "Make a screenshot of selected area", group = "hotkeys" }),
...
awful.rules.rules = {
	...
	-- Add titlebars to normal clients and dialogs
	{
		...
		properties = { titlebars_enabled = fals },
...
-- Autostart
awful.spawn.with_shell("nitrogen --set-zoom-fill ~/Wallpapers/dopamine.png")
